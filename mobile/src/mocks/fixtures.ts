...
export const stations: S['StationListResponse'] = {
  stations: [
...
export const trips: S['TripListResponse'] = {
  trips: [
    {
      tripId: 101,
      trainNo: '101',
 ...
 * 창측은 `A` · `D` (`api.md` §5.1).
 */
export function buildSeatMap(tripId = 101): S['SeatMapResponse'] {
...
export const reservation: S['Reservation'] = {
...
export const me: S['MemberProfile'] = {
...
export const tokens: S['TokenPair'] = {
  accessToken: 'eyJhbGc…',

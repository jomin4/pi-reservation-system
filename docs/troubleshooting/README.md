...
| 날짜 | 증상 | 상태 |
|---|---|---|
| 2026-09-15 | [가짜 예약 데이터가 프로덕션 번들에 들어 있다](front/2026-09-15-mocks-ship-in-production-bundle.md) | 해결 |
...
본체로 넘기지 않는다 (`workflow.md` §1.3.1). 브랜치는 `docs/<track>-*`.

> ⚠️ **아래 색인표는 항상 끝에 추가한다.** 두 트랙이 동시에 문서를 남기면 **이 한 줄짜리 표에서 가장 자주 충돌한다.**

> **남의 트랙 문서를 대신 닫지 않는다.** 「재발 방지」 표에 자기 트랙 줄이 있으면 **자기가 처리하고 자기 줄만 바꾼다.**
